...
const UserSchema = new mongoose.Schema({
  ...
  isFan: { type: Boolean, default: true, required: false },
  isWrestler: { type: Boolean, required: false },
  isOwner: { type: Boolean, required: false },
  isAdmin: { type: Boolean, required: false },
  proName: { type: String, required: false},
  proImage: { type: String, required: false },
  pCloudinaryId: { type: String, required: false },
  height: { type: String, required: false},
  weight: { type: String, required: false},
  biography: { type: String, required: false },
  teammates: { type: [ObjectId], ref: "User", required: false },
